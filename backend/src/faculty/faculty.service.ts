...
export class FacultyService {
  ...
  async list(programaId: string) {
    ...
    return this.corrections.materialize(programaId, TipoEntidade.DOCENTE, faculty);
  }
  ...
  async getFullProfile(id: string) {
    ...
    return { docente: docenteEfetivo[0], producoes: producoesEfetivas, orientacoes: orientacoesEfetivas, projetos: projetosEfetivos, formacoes: formacoesEfetivas };
  }
